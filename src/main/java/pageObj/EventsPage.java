...
@Slf4j
public class EventsPage extends AbsPageObj {
    ...
    public void checkDates() throws ParseException {
        ...
        SimpleDateFormat formatterForCard = new SimpleDateFormat("dd MMMM yyyy");
    ...
    public void selectEventType(EventsTypeData eventsType) {
        String element = String.format("(//a[contains(@title, '%s')])[1]", eventsType.getName());
